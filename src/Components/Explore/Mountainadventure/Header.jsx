    ...
    <div style={{
      ...
      <div
        style={{
          ...
          width: "100%",
          height: "100%",
          backgroundImage: "url('http://wallpapercave.com/wp/3WPcqmR.jpg')",
      ...
      {isMobile && isStatsOpen && (
        <div style={{
          ...
          zIndex: 5, // Increased z-index to ensure it's above everything
          display: "flex",
      ...
      <div style={{
        ...
        <p style={{
          ...
          Discover the world's most beautiful beaches with our exclusive packages
        </p>
